...
const WhatsAppChat = () => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-16 bg-white text-green-500 px-4 py-2 rounded-lg shadow-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap">
        Chat with us
      </span>
    </Link>
  );
