            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">+91 93458 01993</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-emerald-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span className="text-sm sm:text-base text-gray-700">info@kavinmotors.com</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-emerald-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm sm:text-base text-gray-700">Nambiyur, Erode, Tamil Nadu</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-4 sm:p-6 md:p-8 rounded-lg shadow-sm">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <span className="text-sm sm:text-base text-gray-700">Monday - Saturday</span>
                  <span className="text-sm sm:text-base text-gray-700">9:00 AM - 7:00 PM</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm sm:text-base text-gray-700">Sunday</span>
                  <span className="text-sm sm:text-base text-gray-700">Closed</span>
                </div>
              </div>
            </div>
          </div>
