    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-12 md:py-20 bg-gray-900">
        ...
        <div className="relative container mx-auto px-4">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-white mb-4 md:mb-6 text-center tracking-tight">
          ...
          <p className="text-lg md:text-xl text-gray-200 text-center max-w-3xl mx-auto px-4">
