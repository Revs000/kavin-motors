    ...
    <main className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Request a Free Quote</h1>
          <p className="text-gray-600 mb-8">Fill out the form below to receive a detailed quote for your service needs.</p>
